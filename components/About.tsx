        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="bg-white/10 hover:scale-105 hover:bg-white hover:text-black transition duration-300 backdrop-blur-sm rounded-lg p-4 min-w-[120px]"
              >
        ...
        <div className="container mx-auto px-4 ">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <Card
                key={index}
                className="border-1 border-black shadow-lg hover:shadow-xl transition-shadow"
              >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member, index) => (
              <Card
                key={index}
                className="border-1 border-black rounded-lg shadow-lg hover:shadow-xl transition-all hover:-translate-y-1"
              >
